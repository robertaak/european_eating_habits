class PopulationGroupsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @population_group.save
        format.html { redirect_to population_group_url(@population_group), notice: "Population group was successfully created." }
  ...
  def update
    respond_to do |format|
      if @population_group.update(population_group_params)
        format.html { redirect_to population_group_url(@population_group), notice: "Population group was successfully updated." }
  ...
  private
    ...
    def population_group_params
      params.require(:population_group).permit(:name)
    end
end
